...
function main() {
  ...
  projMatrix.setOrtho(-1, 1, -1, 1, 0, 6);
...
function initVertexBuffers(gl) {
  var verticesColors = new Float32Array([
    ...
    0.0,  0.5,  -0.4,  0.4,  1.0,  0.4,  0.01, // The back green one
   -0.5, -0.5,  -0.4,  0.4,  1.0,  0.4,  0.01,
    0.5, -0.5,  -0.4,  1.0,  0.4,  0.4,  0.1, 
   
    0.5,  0.4,  -0.2,  1.0,  0.4,  0.4,  0.4, // The middle yellow one
   -0.5,  0.4,  -0.2,  1.0,  1.0,  0.4,  0.4,
    0.0, -0.6,  -0.2,  1.0,  1.0,  0.4,  0.4, 

    0.0,  0.5,   0.0,  0.4,  0.4,  1.0,  0.99,  // The front blue one 
   -0.5, -0.5,   0.0,  0.4,  0.4,  1.0,  0.99,
    0.5, -0.5,   0.0,  1.0,  0.4,  0.4,  0.9, 
  ]);
  var n = 9;
